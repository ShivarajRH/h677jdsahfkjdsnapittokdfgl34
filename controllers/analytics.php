<?php
	 	...
	 	function jx_order_payment_det($s="",$e="",$fid="")
	{
		...
		$shipped = "select ifnull(sum((b.mrp-(b.discount+b.credit_note_amt))*b.invoice_qty),0) as amt,date_format(a.shipped_on,'%d-%m-%Y') as mn
		 ...
		 $t_array=array_merge($sale_ticks,$payment_ticks,$shipped_ticks);
		 sort($t_array);
		...
		$output['ttl_summary']=$ttl_ord_sales_amt;
		$output['ttl_payment']=$ttl_payment_amt;
		$output['ttl_shipped']=$ttl_shipped_amt;
		echo json_encode($output);
	}
