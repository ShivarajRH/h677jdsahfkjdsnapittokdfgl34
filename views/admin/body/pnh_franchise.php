		...
		<div id="statement">
			<div class="fl_left">
				...
				<?php } ?>
                        ...
                        <div class="clear"></div>
			<?php if(1){?>
				<div style="float: left; margin-top: 33px; margin-left: 0px; background: #f9f9f9; padding: 5px; min-width: 500px;font-size: 12px;">
					...
					<form method="post" id="top_form" action="<?=site_url("admin/pnh_topup/{$fran['franchise_id']}")?>">
						<table cellpadding=3 width="100%">
                            ...
                            <tr class="inst_msg">
								<td>Message</td><td> :</td>
								<td><textarea class="msg" name="msg" style="width:520px;height:80px;" ></textarea></td>
							</tr>
							<tr>
				...
				<div style="float: left; margin-top: 33px; margin-left: 20px; background: #f9f9f9; padding: 5px; max-width: 580px;font-size: 12px;">
						...
						<form method="post" id="acc_change_form" action="<?=site_url("admin/pnh_acc_stat_c/{$fran['franchise_id']}")?>">
							...
							<table cellpadding=3>
								...
								<tr>
									...
									<td><textarea name="desc" class="inp" style="width:400px;height:141px;" ></textarea></td>
								</tr>
								<tr>
