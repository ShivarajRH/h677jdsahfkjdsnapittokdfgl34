                        ...
                        <td>
                            ...
                            <table class="datagrid1" width="100%">
                                ...
                                <?php if($pr['payment_mode']>=0){ ?>
                                        ...
                                        <tr>
                                            <td><?php $transit_types=array("In Hand","Via Courier","With Executive");?><b>Transit Type</b></td>
                                            <td><b>:</b></td>
                                            <td><?=$transit_types[$pr['in_transit']]?>
                            <?php   } ?>
                                                <div style="float: right;">
                                                <?php
                                                if($pr['in_transit']!=0)
                                                {
                                                    ?><a class="transit_link" href="javascript:void(0)" onclick="change_status(<?=$pr['receipt_id']?>)">Change to In Hand</a>
                                                <?php   } ?>
                                                </div>
                                            </td>
                                    </tr>
					...
					<tr><td><b>Remarks</b></td><td><b>:</b></td><td><?=$r['remarks']?></td></tr>
                                ...
                                <td>
                                        <div id="processed_det">
                                                <table class="datagrid1">
                                                <tr><td><b>Bank</b></td><td><b>:</b></td><td><?=$r['submit_bankname']?></td></tr>
                                                <tr><td><b>Remarks</b></td><td><b>:</b></td><td><?=$r['submittedremarks']?></td></tr>
                                                <tr><td><b>Deposited On</b></td><td><b>:</b></td><td><?=format_date($r['submitted_on'])?></td></tr>
                                                <tr><td width="80"><b>Deposited By</b></td><td><b>:</b></td><td><?=$r['submitted_by']?></td></tr>
                                                </table>
				...
				<td>
                                    <div id="realize_det">
                                            <table class="datagrid1">
                                                    ...
                                                    <tr><td><b>Updated On</b></td><td><b>:</b></td><td><?=format_date_ts($r['activated_on'])?></td></tr>
	 ...
	 <table class="datagrid smallheader" width="100%" >
		...
		<td>
			<div>
				...
				<tr><td width="80"><b>Deposited By</b></td><td>:</td><td><?=$cancel['submitted_by']?></td></tr>
				</table>
			</div>
		</td>
		<td>
...
?>
    ...
    <thead><th>Correction Id</th><th>Description</th><th>Credit (Rs)</th><th>Debit (Rs)</th><th>Corrected On</th><th>Un-Reconciled Status</th><th>Actions</th></thead>
	<tbody>
	<?php foreach($account_stat as $ac_st) {
			$credit_amount = $ac_st['credit_amt'];
			$credit_note_id = $ac_st["acc_correc_id"];
			$unreconciled_value = $ac_st["unreconciled_value"];
			$unreconciled_status = $ac_st["unreconciled_status"];
			$reconcile_amount = $ac_st["reconcile_amount"];
			$ac_type = $ac_st['action_type']; 
			//$ac_type_msg = ($ac_type)?'Dr':'Cr';
	?>
                <tr>
                        ...
                        <td><?php if( $credit_amount > 0 ) {
                                        ?><span><?=ucfirst($unreconciled_status);?> &nbsp;</span><span>(<?=$unreconciled_value?>)</span></td><?php
                                }else echo '--';
                                    ?>
                        <td><?php
                                if( $credit_amount > 0 ) { //Only if credit entry
                                        
                                    if($unreconciled_value > 0) { // and if Un- Reconcile value exits  ?>
                                        <a href="javascript:void(0);" onclick="reconcile_cr_amount(this,'<?=$credit_note_id;?>','<?=$credit_amount;?>','<?=$unreconciled_value;?>')" class="button button-tiny button-action cursor">Reconcile</a>
                                        
                                        <?php 
                                    }
                                    if($reconcile_amount > 0) {  //if Re-Concile value exists with this credit note ?>
                                            <!--<span>Rs. <?php // echo $reconcile_amount;?></span>-->
                                            &nbsp;&nbsp;<a href="javascript:void(0);" onclick="clk_view_reconciled_credit_value(this,'<?=$credit_note_id;?>','<?=$ac_st["franchise_id"];?>','<?=$reconcile_amount;?>')" class="button button-tiny button-primary cursor">View Reconciled</a>
                                                <?php
                                    }
