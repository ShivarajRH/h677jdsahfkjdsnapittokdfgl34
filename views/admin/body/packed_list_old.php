...
<thead><tr><th>Sno</th><th>Batch</th><th>Transid</th><th>Proforma Invoice</th><th>Invoice</th><th>Packed on</th><th>By</th><th>Is Shipped?</th><th>Partner ID</th><th>Total Prints</th><th>Invoice PrintedOn</th><th>CourierName</th><th>OutScan Time</th><th>Customer Name</th></tr></thead>
<tbody>
...
<td><?=date("g:ia d/m/y",strtotime($b['packed_on']))?></td>
<td><?=$b['packed_by']?></td>
