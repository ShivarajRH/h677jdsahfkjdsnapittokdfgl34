...
<legend><b>Supplier Info</b></legend>
<table cellpadding="5">
<tr>
	<div>
		<tr><td>Supplier</td><td>|</td><td><a href="<?=site_url("admin/vendor/{$grn['vendor_id']}")?>"><?=$grn['vendor_name']?></a></td></tr>
	
	</div>
</tr>
<tr>
	<div>
		<tr><td><b>Payment Terms</b></td></tr>
...
<tr>
	<div>
		<tr><td>PO Id</td><td>|</td><td><a href="<?=site_url("admin/viewpo/{$poinfo['po_id']}")?>"><?=$poinfo['po_id']?></a></td></tr>
		<tr><td>PO Value</td><td>|</td><td>Rs&nbsp;&nbsp;<?=format_price($poinfo['total_value'])?></td></tr>
		<tr><td>Created On</td><td>|</td><td><?=format_datetime($poinfo['po_created'])?></td></tr>
		<tr><td>Created By</td><td>|</td><td><?=$poinfo['po_createdby']?></td></tr>
	</div>
</tr>
</table>
</fieldset>
...
<tr>
	<div>
		...
		<!--  <tr><td>Invoice No</td><td>|</td><td><?=$invoices['purchase_inv_no']?></td></tr>
		<tr><td>Invoice Value</td><td>|</td><td>Rs&nbsp;&nbsp;<?=format_price($invoices['purchase_inv_value'])?></td></tr>
		<tr><td>Invoice date</td><td>|</td><td><?= format_date($invoices['purchase_inv_date'])?></td></tr>-->
		...
		<!--  <tr><td>Scan Copy</td><td>|</td><td class="hideinprint"><?php if(file_exists(ERP_PHYSICAL_IMAGES."invoices/{$inv['id']}.jpg")){?>
			<a target="_blank" href="<?=ERP_IMAGES_URL?>invoices/<?=$invoices['id']?>.jpg">view</a><?php } else {?> <input type='file' name='scan_0' class='scan_file'>&nbsp;<input type='submit' value='upload' action='<?php echo site_url("admin/do_upload_scan_invoice/{$inv['grn_id']}")?>'><?php }?>
			</td>
		</tr>-->
	</div>
</tr>
...
<thead><th>Sno</th><th >Product</th><th>PO</th><th>Invoiced Qty</th><th>Received Qty</th><th>MRP</th><th>DP Price</th><th>Base Price</th><th>Tax</th><th>Margin</th><th>Scheme discount</th><th>Purchase Price</th></thead>
...
<td align="justify"><?=$p['invoice_qty']?></td>
<td align="justify"><?=$p['received_qty']?></td>
<td><?=$p['mrp']?></td>
<td><?=$p['dp_price']?></td>
...
<!--  <tr class="tbl_stats_row">
 ...
 <tfoot>
<tr>
	<td align="right" colspan="4" style="text-align: left !important;padding-left: 312px !important"><b>Total Inv.Qty : <?=$ttl_in_stk_qty['invoice_qty']?></b></td>
	<td  style="text-align: left !important;padding-right: 59px !important"><b>Total Rec.Qty: <?=$ttl_in_stk_qty['received_qty']?></b></td>
	<td colspan="7" style="text-align: right !important;padding-right: 55px !important"><b>Total Purchase Value : Rs&nbsp;&nbsp;<?=format_price($ttl_grn_purchase_val)?></b></td>
</tr>
