...
?>
	<html>
		...
		<!--<body onload="window.print()">-->
		 	<body>
		 		<h1 style="text-align: center;">Top Product Summary</h1>
			...
			<table class="print_tbl" border="0" cellspacing="0" cellpadding="4" width="100%" >
				<thead>
					<tr>
						...
						<th align="right">Sold in 60 days</th>
						<th align="right">Sold in 7 days</th>
				...
				?>
					<tr>
						...
						<td align="center"><?=$p['sold_in_60_qty']?></td>
						<td align="center"><?=$p['sold_in_7_qty']?></td>
