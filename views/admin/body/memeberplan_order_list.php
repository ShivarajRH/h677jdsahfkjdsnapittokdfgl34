...
$(document).ready(function() {
	plans_val = $('#fmemberplan_table').DataTable({
													...
													"dom": '<"clear">iprftp',
													"sAjaxSource": site_url+"admin/jx_fetch_member_orderplan",		
													"oLanguage": {"sProcessing": "<img src='"+site_url+"/images/jx_loading.gif'>" ,"sSearch": "Orders Search: "}, //for loding image
...
<h2 class="page_title">Member Plan Orders List</h2>
