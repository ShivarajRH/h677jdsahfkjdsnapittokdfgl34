	...
	<div style="clear:both">
		...
		?>
			<table class="datagrid">
				<thead>
					...
					<th colspan="2" style="text-align: center;">This Month Sales</th>
					<th colspan="2" style="text-align: center;">Sales Today</th>
				</thead>
				<tbody>
		...
		?>
					<tr>
						...
						<td><?php echo (int)formatInIndianStyle($total_emp_sales_row['total_sales']);?></td>
						<td><?php echo (int)formatInIndianStyle($total_emp_sales_month_row['total_sales']);?></td>
						<td><?php echo formatInIndianStyle($total_emp_sales_month_row['total_order_value']);?></td>
						<td><?php echo (int)formatInIndianStyle($total_emp_sales_today_row['total_sales']);?></td>
