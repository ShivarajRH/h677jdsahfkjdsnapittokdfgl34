...
<div class="onscreen">
		...
		<div class="head_right_block">
                        <div><b>Printed On : </b><?=Date('d/m/Y'); ?></div>
                        <div><b>Printed By : </b><?php echo $user['username']; ?></div>
                        <div class="print_link_block"><a href="javascript:void(0);" class="print_link" onclick="">Print</a></div>
		</div>
		<div class="heading2">
			<h2 style="">Productwise pick slip for #<?=$this->uri->segment(3)?></h2>	
		</div>
	</div>
        <div class="clear"></div>
