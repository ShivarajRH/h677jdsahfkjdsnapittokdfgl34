...
<div class="page_wrap">
	<div class="page_top" >
		<div class="page_topbar_left fl_left">
			<h2 class="page_title"><?=$v?$v['vendor_name']:'New Vendor'; ?></h2>
		</div>
	</div>
	<div class="page_content">
	
		<form method="post" id="venfrm"  autocomplete="off">
			<input type="submit" value="Submit" style="float:right;margin-left: 188px;margin-top: -35px;" class="button button-action button-rounded button-small">
		...
		<input type="submit" value="Submit" style="float:right;margin-top: 11px;" class="button button-action button-rounded button-small">
