<div class="container">
	<h2 class="page_title">Franchisee Trade Discount Invoices</h2>
	<h1>
		<?php echo $fran_det['franchise_name'];?>
	</h1>
		<div>
			<div align="left"><span style="margin: 10px 0px;"><b>Total Income : Rs.<?php echo formatInIndianStyle($pmt_amt,0,0);?></b> </span></div>
			...
			<table class="datagrid" width="100%">
				...
				<tbody>
					<tr>
						...
						<td><?php echo $c['unreconciled']!=null?$c['unreconciled']:'Unreconciled';?></td>
