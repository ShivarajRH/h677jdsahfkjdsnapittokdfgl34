...
Email : <input type="text" name="email" value="<?=$order['ship_email']?>" size=33>
 ...
 <?php $offers_q = $this->db->query("select a.*,b.first_name,b.user_id from pnh_member_offers a join pnh_member_info b on b.pnh_member_id=a.member_id  where a.transid_ref=? and a.offer_type != 0;",$order['transid']);
