...
<div class="container">
	...
	<div class="dash_bar">Menu :
		<select name="menu" data-placeholder="Choose" id="choose_menu">
	...
	<div class="dash_bar" >Category :
		<select name="sel_cat" data-placeholder="Choose" id="select_cat" >
			<option value="0">Choose</option>
		</select>
	</div>
	...
	<?php if(isset($products)){?>
		<h3><?=$pagetitle?></h3>
		<?=$category?>
			<a style="float:right" onclick="print_warehouse_summary()" >Print summary</a>
