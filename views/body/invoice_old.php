...
<?php }?>
		...
		<div style="padding:5px 0px 10px 0px;font-size:10px;margin-left: 5px;">
			...
			<div style="padding-top:5px;padding-left:200px;">E &amp; O.E.</div>
		</div>
	</div>
	...
	<div style="font-family: arial;">
		...
		<div>
			...
			<table cellpadding="10" width="100%">
				...
				<tr><td colspan="2" align="left">Notes : ____________________________________________________________________________________________________________________________________________ <br><br> ____________________________________________________________________________________________________________________________________________ </td></tr>
			</table>
		</div>
		</div>
	</div>
...
<?php if($is_pnh) { ?>
	...
	var inv_html = $("#invoice").html().replace('TAX INVOICE','TAX INVOICE - Customer Copy');
		...
		inv_html += '<div style="page-break-before:always"></div>';
		$('.tax_block_content').hide();
		inv_html += $("#invoice").html().replace('TAX INVOICE','TAX INVOICE - Company Copy');
